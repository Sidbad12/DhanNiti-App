      ...
      <div className="min-h-screen flex items-center justify-center p-6" style={{ background: "#070a0f" }}>
        <div className="panel max-w-md w-full p-6 text-center space-y-4 border border-red-500/20">
          ...
          <div className="flex gap-3 pt-2">
            <Link href="/dashboard" className="flex-1 px-4 py-2 bg-slate-800 hover:bg-slate-700 text-white rounded font-mono text-xs transition-colors">
              Dashboard
            </Link>
    ...
    <div className="min-h-screen" style={{ background: "#070a0f" }}>
      ...
      >
        <div className="flex items-center gap-3">
          <Link href="/dashboard" className="text-slate-400 hover:text-white font-mono text-xs transition-colors">
            ← BACK TO QUANT
          </Link>
